...
export const CHECK_META: Record<string, CheckMeta> = {
  ...
  'guest-user-visibility':   { effort: 'quick',    impact: 'A guest holding View All Users, or a public external OWD on User, hands unauthenticated visitors the full staff roster — a ready-made target list for phishing and credential stuffing against named admins.' },
