...
// IPP titles verified 2026-06 against the Office of the Privacy Commissioner
// (https://privacy.org.nz/privacy-act-2020/privacy-principles/). Requirement text is a close
// paraphrase of the statute; the legislation site (legislation.govt.nz) is the primary source.
...
export const PRIVACY_ACT_CONTROLS: ControlDef[] = [
  { id: 'PRIVACY-IPP5', framework: 'PRIVACY_ACT', version: V, title: 'IPP 5 — Storage and security of personal information',
    ...
    sourceRef: 'Privacy Act 2020, IPP 5', url: 'https://www.legislation.govt.nz/act/public/2020/0031/latest/LMS23342.html', verified: true },
  { id: 'PRIVACY-IPP9', framework: 'PRIVACY_ACT', version: V, title: 'IPP 9 — Retention of personal information',
    ...
    sourceRef: 'Privacy Act 2020, IPP 9', verified: true },
  { id: 'PRIVACY-IPP12', framework: 'PRIVACY_ACT', version: V, title: 'IPP 12 — Disclosure of personal information outside New Zealand',
    ...
    sourceRef: 'Privacy Act 2020, IPP 12', verified: true },
];
