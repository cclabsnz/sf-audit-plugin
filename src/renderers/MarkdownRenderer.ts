...
export class MarkdownRenderer implements AuditRenderer {
  ...
  render(result: AuditResult): string {
    ...
    lines.push('---');
    lines.push('');
    lines.push('> **Offline-first audit:** all analysis is performed locally; no data is transmitted outside your Salesforce org. Generated by [CloudCounsel SF Audit](https://cloudcounsel.co.nz).');
    lines.push('');
